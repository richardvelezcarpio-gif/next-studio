...
const projects = [
  ...
  { name: "La Casa del Marisco Proposal", type: "Commercial Proposal Website", category: "Websites", status: "Completed", image: "/images/projects/websites-hero.png", url: "" },
...
const labels = {
  en: { title: "Real Projects. Real Business Solutions.", desc: "Explore websites, platforms and digital tools designed to solve real business needs.", cta: "Start Your Project", chat: "Chat on WhatsApp", view: "View Project", learn: "Learn More", prompt: "Have a Project in Mind?", promptText: "Let’s turn your idea into a professional digital solution." },
  es: { title: "Proyectos Reales. Soluciones Reales.", desc: "Explora websites, plataformas y herramientas digitales creadas para resolver necesidades reales.", cta: "Iniciar Tu Proyecto", chat: "Hablar por WhatsApp", view: "Ver proyecto", learn: "Conoce más", prompt: "¿Tienes un Proyecto en Mente?", promptText: "Convirtamos tu idea en una solución digital profesional." },
};
