...
export const AI_CONTENT_STRATEGY_URL =
  process.env.NEXT_PUBLIC_AI_CONTENT_STRATEGY_URL?.trim() ||
  "https://next-studio-ai-content-strategy-pre.vercel.app";
...
export function getNavigation(market: Market, locale: SiteLocale): NavigationEntry[] {
  ...
  return [
    ...
    { label: es ? "IA" : "AI", href: diagnosis, items: [
      { label: "AI Content Strategy", href: AI_CONTENT_STRATEGY_URL, description: es ? "Convierte contenido en una estrategia accionable." : "Turn content into an actionable strategy.", external: true, featured: true, badge: es ? "NUEVO" : "NEW" },
