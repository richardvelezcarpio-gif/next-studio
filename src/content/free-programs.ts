...
export const freePrograms: FreeProgram[] = [
  { slug: "digital-card", href: "/digital-card", image: "/free-programs/digital-card.png", title: { en: "Next Studio Digital Card", es: "Tarjeta Digital Next Studio" }, description: { en: "Share a polished digital introduction for your business.", es: "Comparte una presentación digital profesional de tu negocio." } },
  { slug: "teleprompter", href: "https://www.nextstudiotelepronter.online", image: "/free-programs/teleprompter.png", title: { en: "Teleprompter Video Recorder", es: "Teleprompter y Grabador de Video" }, description: { en: "Record clear, confident videos while following your script.", es: "Graba videos claros y seguros mientras sigues tu guion." } },
  { slug: "construction-business-manager", href: "https://construction-business-manager.vercel.app/", image: "/free-programs/construction-business-manager.png", title: { en: "Construction Business Manager", es: "Administrador para Construcción" }, description: { en: "Organize construction work, clients and daily operations.", es: "Organiza obras, clientes y operaciones diarias de construcción." } },
  { slug: "qr-code-generator", href: "/qr-generator", image: "/free-programs/qr-code-generator.png", title: { en: "QR Code Generator", es: "Generador de Códigos QR" }, description: { en: "Create, customize and download professional QR codes for free.", es: "Crea, personaliza y descarga códigos QR profesionales gratis." } },
